...
var common =
	(function($) {
		...
		/**
		 * @description 网络是否连接正常
		 * @return true 连接正常 false 没有网络，会有提示
		 */
		com.IsConnectedToInternet = function() {
			var isConn = true;
...
(function(com) {
	...
	var Filedownload = function(netPath, callback) {
		...
		//监听当前下载状态，当云服务器中不存在该文件时，查询的特别慢，估计过了3分钟以上才返回status:404，其他时间一直在刷d.state:2
