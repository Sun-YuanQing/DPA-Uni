<template>
	<view class="uni-numbox" :det_id="det_id" :disabled="disabled">
		<view :class="{'uni-numbox--disabled': inputValue <= min || disabled}" class="uni-numbox__minus" @click="_calcValue('minus')">-</view>
		<input :disabled="disabled_input" :disabled_input="disabled_input" v-model="inputValue" class="uni-numbox__value"
		 type="number" @blur="_onBlur">
