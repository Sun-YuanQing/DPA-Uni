	...
	uni.getBLEDeviceServices({
		...
		success: function(res) {
			...
			for (let i = 0; i < res.services.length; i++) {
				...
				if ((res.services[i].uuid.indexOf("49535343-fe7d-4ae5-8fa9-9fafd205e455") != -1) || (res.services[i].uuid.indexOf(
						"49535343-FE7D-4AE5-8FA9-9FAFD205E455") != -1)) {
			...
			uni.getBLEDeviceCharacteristics({
				...
				success: function(res) {
					...
					for (let i = 0; i < res.characteristics.length; i++) {
						...
						if (res.characteristics[i].uuid.indexOf('49535343-1E4D-4BD9-BA61-23C647249616') != -1 || res.characteristics[
								i].uuid.indexOf('49535343-1e4d-4bd9-ba61-23c647249616') != -1) {
						...
						// }
						if (res.characteristics[i].uuid.indexOf('49535343-aca3-481c-91ec-d85e28a60318') != -1 || res.characteristics[
								i].uuid.indexOf('49535343-ACA3-481C-91EC-D85E28A60318') != -1) {
	...
	if (count > maxBit) {
		...
		try {
			uni.writeBLECharacteristicValue({
				...
				success: function(res) {
					console.log("分部传输中" + leftArrayBuffer.byteLength)
					setTimeout(function() {
